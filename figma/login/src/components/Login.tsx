...
import pokemonLogo from 'figma:asset/ff04906eb844cdcf7e52cb6f59b65dfa29b2a1cd.png';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="absolute top-6 left-6 flex gap-3 z-10">
        <button className="w-12 h-12 bg-white/80 backdrop-blur-sm rounded-full border-2 border-purple-300 shadow-lg hover:bg-white hover:scale-110 transition-all flex items-center justify-center group">
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border-4 border-yellow-300">
          ...
          <div className="text-center mb-8">
            ...
            />
            <h1 className="text-3xl mb-2 text-gray-800">포켓몬 스터디룸</h1>
