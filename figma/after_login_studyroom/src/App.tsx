...
import exampleImage from 'figma:asset/60a22333fc5ad207adad8311f0bb5b231df3c4ca.png';
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-12 shadow-lg border-4 border-purple-200">
          ...
          <div className="space-y-6 mb-10">
            ...
            <div className="flex gap-3">
              <span className="text-2xl">🚀</span>
              <p className="text-gray-700">
                <strong>플을 감지 시스템</strong>으로 집중력이 떨어질 때 알려드리고, 귀여운 포켓몬 친구들이 응원해줍니다.
              </p>
            </div>
