    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="relative mb-8">
          {/* 뒤로가기 아이콘 */}
          <button className="absolute left-0 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/80 hover:bg-white transition-colors shadow-sm">
          ...
          <div className="text-center">
            <div className="inline-block px-8 py-3 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-full shadow-lg">
              <h1 className="text-white drop-shadow-md">POKEMON</h1>
            </div>
          </div>
        </div>
